package com.lwgz.meirixue.view;
...
public abstract class ShowingPage extends FrameLayout implements View.OnClickListener {
    ...
    public ShowingPage(Context context) {
        ...
        if (showingpage_loading == null) {
            ...
            ImageView load_image = (ImageView) showingpage_loading.findViewById(R.id.load_image);
            AnimationDrawable drawable = (AnimationDrawable) load_image.getDrawable();
            drawable.start();
        ...
        if (showingpage_load_error == null) {
            ...
            TextView showing_error_tv_reset = (TextView) showingpage_load_error.findViewById(R.id.showing_error_tv_reset);
            ...
            case R.id.showing_error_tv_reset:
                if (NetUtils.getNetWorkType(getContext()) != 0) {
                    ...
                    if(iResetShowingPageListener!=null){
                     iResetShowingPageListener.onResetClick(v);
                    }
                }
                break;
        }
